...
## [Revenue Center (Medicare) Provider Payment Amount](https://www.resdac.org/cms-data/variables/revenue-center-medicare-provider-payment-amount)
...
## [Revenue Center Patient Responsibility Payment Amount](https://www.resdac.org/cms-data/variables/Revenue-Center-Patient-Responsibility-Payment-Amount)

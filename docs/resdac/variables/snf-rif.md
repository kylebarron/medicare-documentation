...
## [HCPCS Initial Modifier Code](https://www.resdac.org/cms-data/variables/hcpcs-initial-modifier-code)
...
## [HCPCS Second Modifier Code](https://www.resdac.org/cms-data/variables/hcpcs-second-modifier-code)
...
## [NCH Qualified Stay From Date](https://www.resdac.org/cms-data/variables/NCH-Qualified-Stay-Date)
...
??? derivation
	...
	DERIVATION RULES:
	Based on the presence of occurrence code 70 move the related occurrence from date to NCH_QLFY_STAY_FROM_DT.

## [NCH Qualify Stay Through Date](https://www.resdac.org/cms-data/variables/NCH-Qualify-Stay-Through-Date)
...
??? derivation
	...
	DERIVATION RULES:
	Based on the presence of occurrence code 70 move the related occurrence thru date to NCH_QLFY_STAY_THRU_DT.
